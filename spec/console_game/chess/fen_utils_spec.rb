...
describe ConsoleGame::Chess::FenUtils do
  ...
  describe "#to_fen" do
    ...
    context "when a value is a valid internal array of a new chess session" do
      let(:session_data) { fen_utils_test.parse_fen(level_double) }

      it "returns a position placements of a new game in FEN format" do
        result = fen_utils_test.send(:to_fen, session_data)
    ...
    context "when a value is a valid internal array of an ongoing chess session" do
      ...
      let(:session_data) { fen_utils_test.parse_fen(level_double, fen_data) }
  ...
  describe "#to_turn_data" do
    ...
    context "when a value is a valid internal array of a new chess session" do
      let(:turn_data) { fen_utils_test.parse_fen(level_double)[:turn_data] }

      it "returns a position placements of a new game in FEN format" do
        result = fen_utils_test.send(:to_turn_data, turn_data)
    ...
    context "when a value is a valid internal array of an ongoing chess session" do
      ...
      let(:turn_data) { fen_utils_test.parse_fen(level_double, fen_data)[:turn_data] }
