...
describe ConsoleGame::Chess::PgnExport do
  describe "#export_session" do
    context "when session is a valid internal game session hash" do
      ...
      let(:session) do
        {
          event: "Dummy User vs Player 2", site: "Ruby Arcade Terminal Chess by Ancient Nimbus",
          date: "08/01/2025 09:17 AM", round: nil, white: "Dummy User", black: "Player 2",
          result: nil, mode: 1, moves: { 1 => %w[e4 e5], 2 => %w[d3 d6], 3 => %w[f3 b5], 4 => %w[g3 a6], 5 => %w[h3 Ra7], 6 => %w[h4 a5], 7 => %w[Nh3 Ra6], 8 => %w[g4 c5], 9 => %w[Be2 Be7], 10 => %w[d4 cxd4], 11 => %w[h5 a4], 12 => %w[b4 d3], 13 => %w[O-O Kf8], 14 => %w[Kh1 d2], 15 => ["Kg1", "dxc1=Q"], 16 => ["Rf2", "Qcxd1+"] },
          white_moves: %w[e4 d3 f3 g3 h3 h4 Nh3 g4 Be2 d4 h5 b4 O-O Kh1 Kg1 Rf2 Rf1],
          black_moves: ["e5", "d6", "b5", "a6", "Ra7", "a5", "Ra6", "c5", "Be7", "cxd4", "a4", "d3", "Kf8", "d2", "dxc1=Q", "Qcxd1+"],
